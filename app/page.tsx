...
import { Droplets, Search, Thermometer, Wind, ChevronsUp, ChevronsDown} from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-500 p-4 flex items-center justify-center">
      <div className="w-full max-w-md space-y-4">
        <h1 className="text-center text-white text-2xl">Basic WeatherApp</h1>
        ...
        {error && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="text-center text-red-600 bg-black rounded-md p-2"
          >
            {error}
          </motion.div>
        )}
            ...
            <Card className="bg-white/70 backdrop-blur">
              <CardContent className="p-6">
                ...
                >
                  ...
                  <ChevronsUp className="w-6 h-6  text-red-600 " />
                ...
                >
                  ...
                  <ChevronsDown className="w-6 h-6  text-blue-400 " />
                  <div className="font-semibold">
                ...
                >
                  <motion.div
                    ...
                    whileHover={{ scale: 1.05 }}
                  >
                    <Thermometer className="w-6 h-6 mx-auto text-red-400" />
                  ...
                  <motion.div
                    ...
                    whileHover={{ scale: 1.05 }}
                  >
                    <Wind className="w-6 h-6 mx-auto text-gray-800" />
